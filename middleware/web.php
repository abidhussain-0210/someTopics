...
*/
 	// Route::middleware('all')->group(function(){
		...
		// //Route::get('admin/media' , [MediaController::class , 'index'])->name('media.index')->withoutMiddleware('test1');
 	// });
	...
	Route::controller(CategoryController::class)->group(function(){
		...
		//Route::get('admin/category/create' , 'create')->name('category.create')->middleware('test1:admin');
		Route::get('admin/category/create' , 'create')->name('category.create')->middleware(['test' , 'test1:admin']);
	...
	Route::controller(MediaController::class)->group(function(){
		...
		//Route::get('admin/media' , 'index')->name('media.index')->middleware('test');
